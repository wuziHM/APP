 ...
 * 加入购物车的效果
 */
public class ShoppingCar2 extends AppCompatActivity {
    ...
    class MyAdapter extends RecyclerView.Adapter<MyVH> {
        ...
        public MyVH onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(ShoppingCar2.this);
...
//      一、创造出执行动画的主题---imageview
        ...
        final ImageView goods = new ImageView(ShoppingCar2.this);
...
//        animatorSet.play(rotation()).after(valueAnimator);
//        animatorSet.start();
...
//                rotation();
    ...
    private ObjectAnimator rotation() {
        ObjectAnimator oaAnimator = ObjectAnimator.ofFloat(cart, "rotation", -45, 45);
        oaAnimator.setDuration(500);
        oaAnimator.setRepeatCount(2);
        return oaAnimator;
//        oaAnimator.start();
    }
