...
public class ObjectFormat {
    ...
    public static String formatPercent(double d, String pattern, Locale l) {
        ...
        try {
            ...
            System.out.println("formatPercent is error!");
        }
        return s;
    }
    ...
    public static void main(String[] args) {
        ...
        String s1 = formatCurrency(1112332377932.89343);
        String s2 = formatCurrency(11120093.8934);
        String a = "88.";
        double d = Double.parseDouble(a);
        System.out.println(d);

        System.out.println(formatCurrency(d));
//        System.out.println(s);
//        System.out.println(s1);
//        System.out.println(s2);
//
//        String s3 = "far,xiixy,hello";
//        for (String st : s3.split(",")) {
