 ...
 */
public class MAutoLoadMoreExpandListView extends ExpandableListView implements MAutoLoadMoreViewAble {

    private static final String TAG = MAutoLoadMoreExpandListView.class.getSimpleName();
    ...
    public MAutoLoadMoreExpandListView(Context context) {
        super(context);
        init();
    }

    public MAutoLoadMoreExpandListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MAutoLoadMoreExpandListView(Context context, AttributeSet attrs, int defStyleAttr) {
