package com.hlib.app.SwipeBack;
...
/**
 * 该库资源有：
 * 1、res/attr_style_swipe_back_layout
 * 2、drawable/m_swipeback_shadow_bottom、m_swipeback_shadow_left、m_swipeback_shadow_right
 * 3、layout/m_swipeback_layout
 */
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mScrollPercent >= 1) {
                if (!mActivity.isFinishing()) {
                    mActivity.finish();
//                    WYActivity.finishActivity(mActivity);
